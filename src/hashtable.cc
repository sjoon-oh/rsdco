...
bool soren::hash::LfHashTable::__elemInsert(
    struct Slot* arg_new, struct Slot* arg_prev, struct Slot* arg_next) {

    do {
        struct Slot* orig_next;
...
/// @param arg_target 
void soren::hash::LfHashTable::__elemDelete(struct Slot* arg_target) {

    struct Slot* next = arg_target->next_slot;
...
void soren::hash::LfHashTable::__elemCleanups(struct List* arg_list) {
    ...
    struct Slot *curr, *prev;           // current cell & previous cell.  
    struct Slot *curr_next, *prev_next; // 
...
/// @param arg_list 
/// @param arg_slot 
void soren::hash::LfHashTable::__elemCleanupAfterSlot(struct List* arg_list, struct Slot* arg_slot) {
...
bool soren::hash::LfHashTable::__elemSearch(
    uint32_t arg_hashval, struct Slot* arg_key, struct Slot** arg_left, struct Slot** arg_right) {
        
    struct List* list = __getBucket(arg_hashval);

    struct Slot* prev       = &list->head;
    struct Slot* prev_next  = prev->next_slot;
    struct Slot* curr       = prev->next_slot; 
    struct Slot* curr_next  = curr->next_slot;
...
bool soren::hash::LfHashTable::doInsert(struct Slot* arg_new, struct Slot* arg_prev, struct Slot* arg_next) {
    return __elemInsert(arg_new, arg_prev, arg_next);
}



bool soren::hash::LfHashTable::doSwitch(struct Slot* arg_new, struct Slot* arg_prev, struct Slot* arg_next) {
...
void soren::hash::LfHashTable::doDelete(struct Slot* arg_target) {
...
void soren::hash::LfHashTable::doCleanupAfterSlot(struct List* arg_list, struct Slot* arg_slot) {
